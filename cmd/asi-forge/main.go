...
func main() {
	...
	gates := []Gate{
		...
		{ID:"F7", Name:"Cross-domain recursive transfer", Status:Insufficient, Evidence:"No executed heterogeneous-domain recursive-transfer gate yet", Interpretation:"Current evidence remains concentrated in formal scalar/string/program domains."},
		{ID:"F8", Name:"Knowledge consolidation", Status:Insufficient, Evidence:"No executed evaluator-protected consolidation-vs-replay gate yet", Interpretation:"Verified memory formation across independent task families is not established."},
		{ID:"F9", Name:"Cognitive substrate replacement", Status:Insufficient, Evidence:"Existing self-extensible tests do not establish domain-general cognitive substrate replacement", Interpretation:"Code self-extension is not being counted as autonomous cognitive replacement."},
		{ID:"F10", Name:"Recursive self-improvement of improvement", Status:Insufficient, Evidence:"F3 shows recursive composition but not increasing future-discovery power", Interpretation:"The current chain does not yet prove that generation n becomes better at producing generation n+1."},
		{ID:"F11", Name:"Resource-normalized improvement", Status:Insufficient, Evidence:"F3 does not use full compute-inclusive C(T)", Interpretation:"R_n < 1 over repeated novel families remains unproven."},
		{ID:"F12", Name:"Adversarial heterogeneous novelty", Status:Insufficient, Evidence:"No completed broad hidden-domain shock battery", Interpretation:"Generalization outside the trained formal substrate is unproven."},
		{ID:"F13", Name:"Open-ended capability growth", Status:Insufficient, Evidence:"No finite-resource open-ended growth demonstration", Interpretation:"Continued capability generation without a hand-authored envelope is unproven."},
		{ID:"F14", Name:"Broad superhuman cognitive battery", Status:Insufficient, Evidence:"No broad independently held-out cognitive battery has passed", Interpretation:"Narrow formal competence cannot be promoted to broad superhuman cognition."},
