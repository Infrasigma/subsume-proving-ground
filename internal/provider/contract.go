...
// ActionContract is the provider-neutral semantic intent presented to a provider.
// It deliberately contains no SQL syntax, database identifiers, credentials, or
