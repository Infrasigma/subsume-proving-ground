...
func RunRecursiveCapabilityProtocolV3() (map[string]float64, error) {
	...
	// The latent threshold is generated by the task lab; the acquisition method
	// sees only behavioral examples and does not receive the latent parameter.
	...
	hidden2 := []ProgramTestCase{
		...
		methodInputOutputExample(5, 1), methodInputOutputExample(9, 1),
	}
	...
	return map[string]float64{
		"verified": 1, "K0_future_solved": 0, "K2_future_solved": 1,
		"method_candidates": float64(len(evals)), "method_diagnosis_confidence": diagnosis.Confidence,
		"method_installed": 1, "future_search_changed": 1, "conditional_signal": 1,
